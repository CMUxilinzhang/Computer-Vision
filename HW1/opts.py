...
def get_opts():
    ...
    # If you want to test default system and optimized system, please use the following paths
    # DO NOT USE the following path to run main.py(because <.npy> and <.npz> may be updated)
    # I directly load the <.npz> and <.npy> from the 'out-dir in <visual_recog.py>'
    '''
    # test default system
    parser.add_argument('--out-dir', type=str, default='../default_dic_and_trainsys', help='output folder')
    # test optimized system
    parser.add_argument('--out-dir', type=str, default='../optimized_dic_and_trainsys', help='output folder')
    '''
